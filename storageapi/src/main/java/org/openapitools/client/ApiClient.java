...
public class ApiClient {
    ...
    private String basePath = "https://storage-api.azion.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://storage-api.azion.com",
      "prod",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://stage-storage-api.azion.com",
      "stage",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://storage-api.azion.com

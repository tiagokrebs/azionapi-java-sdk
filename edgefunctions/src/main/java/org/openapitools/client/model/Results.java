...
public class Results {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, language, code, jsonArgs, functionToRun, initiatorType, active, lastEditor, modified, referenceCount);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Results
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Results.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Results.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Results` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

...
public class DataStreamingEndpointTypeStandard {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataStreamingEndpointTypeStandard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataStreamingEndpointTypeStandard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataStreamingEndpointTypeStandard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataStreamingEndpointTypeStandard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("headers") != null && !jsonObj.get("headers").isJsonNull()) {
        DataStreamingEndpointTypeStandardHeadersExample.validateJsonObject(jsonObj.getAsJsonObject("headers"));
      }
  }

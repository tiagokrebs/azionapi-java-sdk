...
public class DataStreamingResponseGetResultTypeDatadogDTS {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DataStreamingResponseGetResultTypeDatadogDTS
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataStreamingResponseGetResultTypeDatadogDTS.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataStreamingResponseGetResultTypeDatadogDTS.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataStreamingResponseGetResultTypeDatadogDTS` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("endpoint") != null && !jsonObj.get("endpoint").isJsonNull()) {
        DataStreamingEndpointTypeDatadogDTS.validateJsonElement(jsonObj.get("endpoint"));
      }
  }

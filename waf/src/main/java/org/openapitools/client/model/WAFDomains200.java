...
public class WAFDomains200 {
  ...
  **/
  ...
  public WAFDomains200 schemaVersion(Integer schemaVersion) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WAFDomains200
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WAFDomains200.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WAFDomains200.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WAFDomains200` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

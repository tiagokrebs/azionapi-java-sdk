...
public class WAFEvents404 {
  ...
  **/
  ...
  public WAFEvents404 schemaVersion(Integer schemaVersion) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WAFEvents404
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WAFEvents404.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WAFEvents404.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WAFEvents404` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

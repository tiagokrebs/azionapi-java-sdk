...
public class WAFEvents400 {
  ...
  **/
  ...
  public WAFEvents400 schemaVersion(Long schemaVersion) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to WAFEvents400
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WAFEvents400.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WAFEvents400.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WAFEvents400` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3002";
    ...
    new ServerConfiguration(
      "http://stage-bff-gke.azion.net:3002",
      "Staging",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://bff.azion.net:3002",
      "Production",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3002

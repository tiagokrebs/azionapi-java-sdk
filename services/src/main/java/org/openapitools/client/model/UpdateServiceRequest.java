...
public class UpdateServiceRequest {
  ...
  public UpdateServiceRequest active(Boolean active) {
  ...
  **/
  ...
  public UpdateServiceRequest variables(List<Variable> variables) {
    
    this.variables = variables;
    return this;
  }

  public UpdateServiceRequest addVariablesItem(Variable variablesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, updateServiceRequest.active) &&
        Objects.equals(this.name, updateServiceRequest.name) &&
        Objects.equals(this.variables, updateServiceRequest.variables);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, name, variables);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateServiceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServiceRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

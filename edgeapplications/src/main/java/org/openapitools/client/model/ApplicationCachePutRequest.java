...
public class ApplicationCachePutRequest {
  ...
  public ApplicationCachePutRequest name(String name) {
  ...
  **/
  ...
  public ApplicationCachePutRequest browserCacheSettings(String browserCacheSettings) {
  ...
  **/
  ...
  public ApplicationCachePutRequest browserCacheSettingsMaximumTtl(Long browserCacheSettingsMaximumTtl) {
  ...
  **/
  ...
  public ApplicationCachePutRequest cdnCacheSettings(String cdnCacheSettings) {
  ...
  **/
  ...
  public ApplicationCachePutRequest cdnCacheSettingsMaximumTtl(Long cdnCacheSettingsMaximumTtl) {
  ...
  **/
  ...
  public ApplicationCachePutRequest cacheByQueryString(String cacheByQueryString) {
  ...
  **/
  ...
  public ApplicationCachePutRequest queryStringFields(List<String> queryStringFields) {
    
    this.queryStringFields = queryStringFields;
    return this;
  }

  public ApplicationCachePutRequest addQueryStringFieldsItem(String queryStringFieldsItem) {
  ...
  **/
  ...
  public ApplicationCachePutRequest enableQueryStringSort(Boolean enableQueryStringSort) {
  ...
  **/
  ...
  public ApplicationCachePutRequest cacheByCookies(String cacheByCookies) {
  ...
  **/
  ...
  public ApplicationCachePutRequest cookieNames(List<String> cookieNames) {
    
    this.cookieNames = cookieNames;
    return this;
  }

  public ApplicationCachePutRequest addCookieNamesItem(String cookieNamesItem) {
  ...
  **/
  ...
  public ApplicationCachePutRequest l2CachingEnabled(Boolean l2CachingEnabled) {
  ...
  **/
  ...
  public ApplicationCachePutRequest isSliceConfigurationEnabled(Boolean isSliceConfigurationEnabled) {
  ...
  **/
  ...
  public ApplicationCachePutRequest isSliceEdgeCachingEnabled(Boolean isSliceEdgeCachingEnabled) {
  ...
  **/
  ...
  public ApplicationCachePutRequest isSliceL2CachingEnabled(Boolean isSliceL2CachingEnabled) {
  ...
  **/
  ...
  public ApplicationCachePutRequest sliceConfigurationRange(Long sliceConfigurationRange) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationCachePutRequest applicationCachePutRequest = (ApplicationCachePutRequest) o;
    return Objects.equals(this.name, applicationCachePutRequest.name) &&
        Objects.equals(this.browserCacheSettings, applicationCachePutRequest.browserCacheSettings) &&
        Objects.equals(this.browserCacheSettingsMaximumTtl, applicationCachePutRequest.browserCacheSettingsMaximumTtl) &&
        Objects.equals(this.cdnCacheSettings, applicationCachePutRequest.cdnCacheSettings) &&
        Objects.equals(this.cdnCacheSettingsMaximumTtl, applicationCachePutRequest.cdnCacheSettingsMaximumTtl) &&
        Objects.equals(this.cacheByQueryString, applicationCachePutRequest.cacheByQueryString) &&
        Objects.equals(this.queryStringFields, applicationCachePutRequest.queryStringFields) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicationCachePutRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicationCachePutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationCachePutRequest is not found in the empty JSON string", ApplicationCachePutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApplicationCachePutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationCachePutRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicationCachePutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationCachePutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationCachePutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationCachePutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationCachePutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationCachePutRequest>() {
           @Override
           public void write(JsonWriter out, ApplicationCachePutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationCachePutRequest read(JsonReader in) throws IOException {

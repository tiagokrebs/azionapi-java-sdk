...
public class OriginsIdResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to OriginsIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OriginsIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OriginsIdResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OriginsIdResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      OriginsResultResponse.validateJsonObject(jsonObj.getAsJsonObject("results"));
  }

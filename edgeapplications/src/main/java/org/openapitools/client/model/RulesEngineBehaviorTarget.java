...
public class RulesEngineBehaviorTarget extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RulesEngineBehaviorTarget.class.isAssignableFrom(type.getRawType())) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RulesEngineBehaviorTarget>() {
                @Override
                public void write(JsonWriter out, RulesEngineBehaviorTarget value) throws IOException {
    ...
    public RulesEngineBehaviorTarget(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RulesEngineBehaviorTarget(RulesEngineBehaviorTargetOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RulesEngineBehaviorTarget(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, RulesEngineBehaviorTargetOneOf, String");
    }
     ...
     * BigDecimal, RulesEngineBehaviorTargetOneOf, String
     *
     * @return The actual instance (BigDecimal, RulesEngineBehaviorTargetOneOf, String)
     */
    @Override
     ...
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `RulesEngineBehaviorTargetOneOf`
     * @throws ClassCastException if the instance is not `RulesEngineBehaviorTargetOneOf`
     */
    public RulesEngineBehaviorTargetOneOf getRulesEngineBehaviorTargetOneOf() throws ClassCastException {
 ...
 /**
  * Create an instance of RulesEngineBehaviorTarget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RulesEngineBehaviorTarget
  * @throws IOException if the JSON string is invalid with respect to RulesEngineBehaviorTarget
  */
  public static RulesEngineBehaviorTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RulesEngineBehaviorTarget.class);
  }

 /**
  * Convert an instance of RulesEngineBehaviorTarget to an JSON string
  *
  * @return JSON string
  */

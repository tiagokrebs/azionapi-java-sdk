...
public class DeviceGroupsIdResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceGroupsIdResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceGroupsIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeviceGroupsIdResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeviceGroupsIdResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      DeviceGroupsResultResponse.validateJsonElement(jsonObj.get("results"));
  }

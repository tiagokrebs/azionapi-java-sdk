  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createOriginsRequest.name) &&
        ...
        Objects.equals(this.bucket, createOriginsRequest.bucket) &&
        Objects.equals(this.prefix, createOriginsRequest.prefix);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOriginsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOriginsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
